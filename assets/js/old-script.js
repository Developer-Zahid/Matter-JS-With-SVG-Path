...
function getResponsivePixelRatio(){
    return (/Mobi|Android|iPhone/i.test(navigator.userAgent)) ? 2 : 1
}
...
//         const regularScaleFactor = (Array.from(document.querySelectorAll('.matter-svg'))[body.render.index].clientWidth / designElementsCanvasWidth);
